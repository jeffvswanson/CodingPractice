...
"""Do Programming Exercise 8 from Chapter 4, but add a decision to prevent the
program from dividing by zero if the line is vertical."""
...
and slope of the line.""")
    ...
    if dx != 0:
        ...
        slope = dy/dx
        print("The line segment slope, m, is:", slope)

        # Calculate and display the line segment length
        length = math.sqrt(dx**2 + dy**2)
        print("The line segment length, l, is:", length)
    else:
        print("dx is zero, therefore, the slope is infinite!")
    

    # Wait for another click to ext.
